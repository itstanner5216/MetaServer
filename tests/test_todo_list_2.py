...
def test_admin_tools_imports_use_meta_mcp_package():
    ...
    assert "from meta_mcp.middleware import" in source_code, (
        "Should use 'from meta_mcp.middleware' not 'from src.meta_mcp.middleware'"
    )
...
def test_admin_tools_governance_components_accessible():
    ...
    """
    try:
        from servers.admin_tools import admin_server, governance_state
