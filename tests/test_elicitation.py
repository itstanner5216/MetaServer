...
async def test_approval_creates_audit_log(
    ...
    Note: Uses tmp_path via audit_log_path fixture for deterministic testing
    """
    # Setup
    middleware = GovernanceMiddleware()
    mock_fastmcp_context.request_context.tool_name = "write_file"
    ...
    # Flush audit log to ensure writes are complete
    from src.meta_mcp.audit import audit_logger
    audit_logger.flush()

    # Read audit log from the fixture-provided temp path
