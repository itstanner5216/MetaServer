...
async def test_cross_session_isolation():
    ...
    """
    # TODO: Import lease_manager when Phase 3 is implemented
...
@pytest.mark.asyncio
async def test_bootstrap_tools_skip_lease_check():
    """
    ...
    # Simulate middleware check for bootstrap tool
    # Should NOT require lease validation
    # from src.meta_mcp.supervisor import search_tools

    # Call search_tools without any prior lease
    # result = search_tools.fn(query="file")
    # assert "read_file" in result or "write_file" in result

    # Call get_tool_schema without prior lease
...
@pytest.mark.asyncio
async def test_lease_consumption_only_on_success():
    """
...
@pytest.mark.asyncio
async def test_lease_not_granted_without_client_id():
    """
...
@pytest.mark.asyncio
async def test_calls_remaining_decrements_correctly():
    """
...
@pytest.mark.asyncio
async def test_lease_ttl_enforced():
    """
    ...
    # key = f"lease:test_session:read_file"
...
@pytest.mark.asyncio
async def test_lease_mode_consistency():
    """
...
@pytest.mark.asyncio
async def test_multiple_leases_per_session():
    """
...
@pytest.mark.asyncio
async def test_lease_fail_closed_on_redis_error():
    """
