...
class GeminiEmbedderAdapter(EmbedderAdapter):
    """Backward-compatible Google embedding adapter implementation."""
    ...
    def embed_batch(self, texts: list[str]) -> list[EmbeddingResult]:
        """Batch embed texts through the configured API with retry."""
        results = []
...
def get_embedder() -> EmbedderAdapter:
    """Create an embedder adapter from centralized configuration."""
